 ...
 * These rows gets processed by the pushRowFunction
 * @param {Map} headerQueryMap
 * @param {[{}]} dataset
 * @param {function (dataRow)} pushRowFunction
 */
internals.generateDataRows = (headerQueryMap, dataset, pushRowFunction) => {
